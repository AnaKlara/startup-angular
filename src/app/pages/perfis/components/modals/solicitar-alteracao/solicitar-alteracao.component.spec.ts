...
import { SolicitarAlteracaoComponent } from './solicitar-alteracao.component';

describe('SolicitarAlteracaoComponent', () => {
  let component: SolicitarAlteracaoComponent;
  let fixture: ComponentFixture<SolicitarAlteracaoComponent>;
  let dialogRefSpy: jest.Mocked<MatDialogRef<SolicitarAlteracaoComponent>>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [SolicitarAlteracaoComponent, UploadableAreaComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SolicitarAlteracaoComponent);
  ...
  it('should remove an anexo at the given index when removerAnexo is called', () => {
    ...
    component.solicitacao.get('anexos')?.setValue(anexos);

    component.removerAnexo(1); // Removes 'file2'

    const updatedAnexos = component.solicitacao.get('anexos')?.value;
  ...
  it('should return the correct length of comentario when comentarioLength is called', () => {
    component.solicitacao.get('comentario')?.setValue('Test Comment');
